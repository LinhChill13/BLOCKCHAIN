...
export default function CreateCampaignPage() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      writeContract({
        ...
        args: [beneficiary, parseEther(target), BigInt(deadlineTimestamp), name || "campaign-untitled"]
      });
    } catch (cause) {
  ...
  return (
    <main><SiteHeader /><section className="shell form-layout">
      <div className="form-intro"><p className="eyebrow">CAMPAIGN MỚI</p><h1>Tạo một lời kêu gọi<br />đáng tin cậy.</h1><p>Ví kết nối sẽ trở thành creator. Beneficiary là ví duy nhất được rút tiền sau khi chiến dịch kết thúc hoặc được đóng.</p></div>
